...
class URL:
    ...
    * `url.port` is either None or an integer. URLs that include the default port for
      ...
      assert httpx.URL("https://example.com") == httpx.URL("https://example.com:80")
      assert httpx.URL("https://example.com").port is None
      assert httpx.URL("https://example.com:80").port is None
    ...
    * `url.query` is raw bytes, without URL escaping. A URL query string portion can
    ...
    def host(self) -> str:
        ...
        url = httpx.URL("https://www.EXAMPLE.org")
    ...
    def port(self) -> int | None:
        ...
        assert httpx.URL("https://www.example.com") == httpx.URL("https://www.example.com:80")
        assert httpx.URL("https://www.example.com:80").port is None
        """
    ...
    def is_absolute_url(self) -> bool:
        """
        Return `True` for absolute URLs such as 'https://example.com/path',
    ...
    def is_relative_url(self) -> bool:
        """
        Return `False` for absolute URLs such as 'https://example.com/path',
