...
class AnyUrl(_BaseUrl):
    ...
    * Host not required
    ...
    Assuming an input URL of `https://samuel:pass@example.com:8000/the/path/?query=here#fragment=is;this=bit`,
...
class HttpUrl(AnyUrl):
    ...
    * Max length 2083
    ...
    m = MyModel(url='https://www.example.com')  # (1)!
    print(m.url)
    ...
    1. Note: mypy would prefer `m = MyModel(url=HttpUrl('https://www.example.com'))`, but Pydantic will convert the string to an HttpUrl instance anyway.
    ...
    m1 = MyModel(url='https://puny£code.com')
    print(m1.url)
    #> https://xn--punycode-eja.com/
    ...
    !!! warning "Underscores in Hostnames"
        ...
        Also, Chrome, Firefox, and Safari all currently accept `https://exam_ple.com` as a URL, so we're in good
...
class PostgresDsn(_BaseMultiHostUrl):
    ...
    * Supports multiple hosts
    ...
    m = MyModel(url='https://www.example.com')
...
if TYPE_CHECKING:
    ...
    class IPvAnyAddress:
        ...
        try:
            IpModel(ip='https://www.example.com')
