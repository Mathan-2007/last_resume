...
https://opensource.adobe.com/wiki/display/cmap/CMap+Resources

The follwing files were extracted from the downloadable tarballs:

cid2code_Adobe_CNS1.txt:
	https://download.macromedia.com/pub/opensource/cmap/cmapresources_cns1-6.tar.z

cid2code_Adobe_GB1.txt:
	https://download.macromedia.com/pub/opensource/cmap/cmapresources_gb1-5.tar.z

cid2code_Adobe_Japan1.txt:
	https://download.macromedia.com/pub/opensource/cmap/cmapresources_japan1-6.tar.z

cid2code_Adobe_Korea1.txt:
	https://download.macromedia.com/pub/opensource/cmap/cmapresources_korean1-2.tar.z
